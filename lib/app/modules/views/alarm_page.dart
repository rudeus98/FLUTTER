...
class _AlarmPageState extends State<AlarmPage> {
  ...
  void scheduleAlarm(DateTime scheduledNotificationDateTime, AlarmInfo alarmInfo, {required bool isRepeating}) async {
    if (scheduledNotificationDateTime.isBefore(DateTime.now())) {
      ...
      scheduledNotificationDateTime = scheduledNotificationDateTime.add(Duration(days: 1)); // Handle if the scheduled time is in the past
      // Debugging if the time was adjusted
      print('Adjusted scheduled time to: $scheduledNotificationDateTime');
    }
